...
/* In a future release of Bison, this section will be replaced
   by #include "plural.h".  */
#ifndef YY_GETTEXT_PLURAL_H_INCLUDED
# define YY_GETTEXT_PLURAL_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
#if YYDEBUG
extern int gettext__debug;
#endif
...
#endif /* !YY_GETTEXT_PLURAL_H_INCLUDED  */
