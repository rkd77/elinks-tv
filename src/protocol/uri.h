...
struct uri *get_uri(unsigned char *string, uri_component_T components);
...
struct string *add_string_uri_to_string(struct string *string, unsigned char *uristring, uri_component_T components);
