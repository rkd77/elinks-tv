		  ...
		  struct html_context *html_context)
{
	...
	/* The template_ char is the last we need to draw so only decrease @width. */
		  ...
		  struct html_context *html_context)
{
	...
	/* The template_ char is the first vertical char to be drawn. So
	 * copy it to the rest. */
...
color_link_lines(struct html_context *html_context)
{
	...
	int color_mode = document->options.color_mode;
