...
static hash_value_T strhash(const unsigned char *k, unsigned int length, hash_value_T initval);
 ...
 * @relates hash */
struct hash_item *
add_hash_item(struct hash *hash, const unsigned char *key, unsigned int keylen,
	      void *value)
{
...
/** @relates hash */
struct hash_item *
get_hash_item(struct hash *hash, const unsigned char *key, unsigned int keylen)
{
